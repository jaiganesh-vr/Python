...
# This is a statistical sampling approximation algorithm that simply simulates the game for a fixed number of dice
# rolls. An exact algorithm would involve calculating the eigenvector of the largest eigenvalue of the transition
# matrix (which is practical), but averaging over all possible permutations of both the Chance and Community Chest
# decks (which is computationally infeasible).
def compute():
    TRIALS = 10 ** 7
